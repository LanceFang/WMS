...
using BM.WMS.Authorization.Users.Exporting;
using BM.WMS.Dto;
...
namespace BM.WMS.Authorization.Users
{
    ...
    public class UserAppService : WMSAppServiceBase, IUserAppService
    {
        ...
        protected virtual async Task CreateUserAsync(CreateOrUpdateUserInput input)
        {
            ...
            //Notifications
            await _notificationSubscriptionManager.SubscribeToAllAvailableNotificationsAsync(new UserIdentifier(user.TenantId, user.Id));
