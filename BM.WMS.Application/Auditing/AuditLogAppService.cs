...
using BM.WMS.Auditing.Exporting;
...
namespace BM.WMS.Auditing
{
    ...
    public class AuditLogAppService : WMSAppServiceBase, IAuditLogAppService
    {
        ...
        public async Task<AuditLogAndUser> GetAuditLogAndUserById(int Id)
        {
