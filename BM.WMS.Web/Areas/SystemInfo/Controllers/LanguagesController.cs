...
using BM.WMS.Web.Areas.SystemInfo.Models.Languages;
...
namespace BM.WMS.Web.Areas.SystemInfo.Controllers
{
    ...
    public class LanguagesController : WMSControllerBase
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            ViewBag.defaultLanguage = await _languageAppService.GetDefaultLanguage();
