(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'SystemInfo/OrganizationUnits/CreateModal',
            scriptUrl: abp.appPath + 'Areas/SystemInfo/Views/OrganizationUnits/_CreateModal.js',
            modalClass: 'CreateOrganizationUnitModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'SystemInfo/OrganizationUnits/EditModal',
            scriptUrl: abp.appPath + 'Areas/SystemInfo/Views/OrganizationUnits/_EditModal.js',
