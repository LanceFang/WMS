...
(function ($) {
    ...
    $.fn.pagination.defaults = {
        total: 1, pageSize: 25, pageNumber: 1, pageList: [10, 25, 50, 80, 100], loading: false, buttons: null, showPageList: true, showRefresh: true, links: 10, layout: ["list", "sep", "first", "prev", "sep", "manual", "sep", "next", "last", "sep", "refresh"], onSelectPage: function (_d1, _d2) {
